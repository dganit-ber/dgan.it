            ...
            <div id='overview' className='scroll-mt-28'>
              <Reveal>
                ...
                <p className='mt-5 max-w-[56ch] text-lg leading-relaxed text-mute'>
                  ...
                  Fiction Library is a web app and browser extension that lets
                  readers save a work in one click, sort it into collections,
                  keep private notes, and track what they&rsquo;re reading —
            ...
            <Section id='problem'>
              <Reveal>
                ...
                <p className='mb-4 text-mute'>
                  AO3 readers routinely track hundreds of works. The
                  archive&rsquo;s own bookmarks are a single chronological list:
                  no shelves, no reading status, no way to note{' '}
                  <em className='text-mute italic'>why</em> you saved something.
                  Readers work around it with spreadsheets, notes apps, and
                ...
                <p className='mb-6 text-mute'>
                  ...
                  . The design goal was a library that fits into the reading
                  habit already in place, rather than asking anyone to move
                  house.
                </p>
                <Bullets
                  items={[
                    ...
                    <>
                      ...
                      Works get updated, locked, or deleted — the library has to
                      cope.
                    </>,
                  ]}
                />
            ...
            <Section id='how-its-built'>
              <Reveal>
                ...
                <p className='mb-8 max-w-[60ch] text-mute'>
                  ...
                  Switch between what the reader experiences and what runs
                  underneath.
                </p>
              </Reveal>
            ...
            <Section id='decision-log'>
              <Reveal>
                ...
                <p className='mb-8 max-w-[58ch] text-mute'>
                  Sole-developer projects don&rsquo;t have code review, so the
                  useful record is the one you keep yourself. These are the
                  decisions that changed how the rest of the app is written.
                </p>
              </Reveal>
              ...
              <div className='flex flex-col gap-4'>
                ...
                <DecisionEntry
                  ...
                  result={
                    <>
                      Form errors say what&rsquo;s actually wrong, and the
                      distinction between &ldquo;invalid input&rdquo; and
                      &ldquo;something broke&rdquo; is enforced by types.
                    </>
                  }
                />
                <DecisionEntry
            ...
            <Section id='results'>
              <Reveal>
                ...
                <p className='mb-8 text-mute'>
                  The site is live, the Chrome extension is published on the
                  Chrome Web Store, and the Firefox version is approved on
                  Mozilla Add-ons — including Firefox for Android, which makes
                  it one of the few ways to do this from a phone at all.
                </p>
              </Reveal>
              ...
              <div className='grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2'>
                <NextItem
                  label='Sources'
                  value='FanFiction.net alongside AO3'
                />
                <NextItem
                  label='Theming'
                  value='Light mode across site and extension'
                />
                <NextItem
                  label='Organisation'
                ...
                <NextItem
                  label='Import'
                  value='Bulk import from AO3 bookmarks'
                />
                <NextItem
                  label='Insight'
                  value='Reading wrap — a period in numbers'
                />
                <NextItem
                  label='Automation'
