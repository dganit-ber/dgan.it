...
const SECTIONS = [
  ...
  { id: 'problem', index: '02', label: 'The problem' },
  { id: 'how-its-built', index: '03', label: "How it's built" },
  { id: 'decision-log', index: '04', label: 'Decision log' },
  { id: 'results', index: '05', label: 'Where it stands' },
];
