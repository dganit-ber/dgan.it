...
export default function Footer() {
  return (
    <footer className='footer glass sticky bottom-0 z-40 border-t border-border px-6 py-3 text-xl'>
      <div className='mx-auto flex max-w-6xl items-center justify-between gap-4'>
        ...
        <div className='flex items-center gap-4'>
          <Link
            href='/impressum'
            className='text-sm font-medium text-muted transition-colors hover:text-accent hover:underline'
          >
            Impressum
          </Link>
          <Link
